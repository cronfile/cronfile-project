...
<div id = "header">
  ...
  <a href="quicklinks.php">Quicklinks</a>
   ...
   <h2> Found Something?</h2>
    <h3>Create a new request for your found item, or check database for lost items.</h3>
     
    <form action="found.php" method="POST" >
    <table>
    
        <tr><td>Enter your name:</td><td><input type = "text" placeholder=" Your name" name = "finder" value="<?php if (isset($_POST['finder'])) echo $_POST['finder'];?>"></td></tr><br>
    
        <tr><td>Enter item name:</td><td><input type = "text" placeholder="Item name" name = "item_name" value="<?php if (isset($_POST['item_name'])) echo $_POST['item_name'];?>"></td></tr><br>
    
        <tr><td>Enter description here:</td><td><input type = "text" placeholder="Description" name="description" value="<?php if (isset($_POST['description'])) echo $_POST['description'];?>"></td></tr>
    
        <tr><td>Date item was found:</td><td><input type="datetime-local" placeholder="Month/Day/Year" name="create_date" value="<?php if (isset($_POST['create_date'])) echo $_POST['create_date'];?>"></td></tr>
        ...
        <tr><td>Location:</td><td><select name = "location_id" value="<?php if (isset($_POST['location_id'])) echo $_POST['location_id'];?>">
				        ...
				        <option value="Foy Townhouses">Foy Tonhouses</option>
       ...
       <tr><td colspan="2"><input id = "submitbtn" type = "submit" value="Submit Found Item"></td></tr>
...
if ($_SERVER [ 'REQUEST_METHOD' ] == 'POST' ){
	...
	if ( !valid_item_name($item_name) )
		echo '<p style="color:red; font-size:20px;"> Invalid ID </p>' ;
	else if ( !valid_finder($finder) )
		echo '<p style="color:red; font-size:20px;"> Invalid name </p>' ;
	else
